...
var burgerCloseButton = document.querySelector('.menu__button--close');
var asideMenu = document.querySelector('.menu');
var blurredWrapper = document.querySelector('.blurred-wrapper');
var breakPointLarge = window.matchMedia('(min-width: 1440px)'); //Переменные формы обратной связи

var feedbackForm = document.querySelector('.modal--feedback');
var callFormsNodeList = document.querySelectorAll('.repair-bid-container'); //Переменные формы "Заказать звонок"

var callBackForm = document.querySelector('.modal--callBack'); //Навешиваем обработчики событий на кнопки, вызывающие формы

var _iterator = _createForOfIteratorHelper(callFormsNodeList),
    _step;

try {
  for (_iterator.s(); !(_step = _iterator.n()).done;) {
    var element = _step.value;
    element.querySelector('.button--repair').addEventListener('click', function () {
      feedbackForm.classList.add('modal--active');
      blurredWrapper.hidden = false;
    });
    element.querySelector('.button--check-status').addEventListener('click', function () {
...
feedbackForm.querySelector('.button--close').addEventListener('click', function () {
  feedbackForm.classList.remove('modal--active');
  blurredWrapper.hidden = true;
});
callBackForm.querySelector('.button--close').addEventListener('click', function () {
...
blurredWrapper.addEventListener('click', function () {
...
breakPointLarge.addEventListener('change', function () {
...
/* harmony import */ var _seeMore_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./seeMore.js */ "./src/js/seeMore.js");
/* harmony import */ var _seeMore_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_seeMore_js__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _swipers_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./swipers.js */ "./src/js/swipers.js");
...
var content = document.querySelector('.services__text-wrapper');
var breakPoint = window.matchMedia('(min-width: 767px)');
var button = document.querySelector('.view-all-button');
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var swiperSecond;
  var swiperThird;
  var swiperBrends = document.querySelector('.slider__swiper--first');
  var swiperDevices = document.querySelector('.slider__swiper--second');
  var swiperPrices = document.querySelector('.price__table--slider');
  var showMoreButtonBrends = document.querySelector('.brends__view-all-button');
  var showMoreButtonDevices = document.querySelector('.devices__view-all-button');
  var breakPointSwiper = window.matchMedia('(max-width: 767px)');
  ...
  function initSwiper() {
    if (breakPointSwiper.matches) {
      swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.slider__swiper--first', swiperParameters);
      swiperSecond = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.slider__swiper--second', swiperParameters);
      swiperThird = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.price__table--slider', pricesSliderParameters);
    } else {
      if (swiper !== undefined) {
  ...
  showMoreButtonBrends.addEventListener('click', function () {
    contentExpander(showMoreButtonBrends, swiperBrends);
  });
  showMoreButtonDevices.addEventListener('click', function () {
